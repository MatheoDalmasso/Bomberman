...
/**
 * La classe MapFactory3 est une fabrique de cartes pour le jeu Bomberman.
 * Elle utilise le générateur de cartes MapGenerator3 pour créer une carte.
 */
public class MapFactory3 implements IMapFactory {
    ...
    /**
     * Crée une nouvelle instance de MapFactory3.
     *
     ...
     */
    public MapFactory3(int height, int width, ISpriteStore spriteStore) {
        this.height = height;
        this.width = width;
    ...
    /**
     * Crée une carte en utilisant le générateur de cartes MapGenerator3.
     *
     * @return La carte générée.
     */
    @Override
    public GameMap createMap() {
        return new MapGenerator3(height / spriteStore.getSpriteSize(), width / spriteStore.getSpriteSize()).genererMap();
    }
}