...
/**
 * La classe LifeBonus représente un bonus de vie dans le jeu Bomberman.
 * Lorsqu'un joueur entre en collision avec ce bonus, il gagne une vie supplémentaire.
 */
public class LifeBonus extends AbstractMovable implements IWallState {

    /**
     * Crée une nouvelle instance de LifeBonus.
     *
    ...
    public void collidedWith(IMovable other) {
        if (other.isPlayer()) {
            game.getPlayer().addLife(1); // Ajoute une vie au joueur
     ...
     *
     * @return false car ce bonus n'est pas un bonus invisible.
     */
    @Override
     ...
     *
     * @return true car ce bonus est un bonus de vie.
     */
    @Override
